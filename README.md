...
App 依赖自建的 [Tomato-Novel-Downloader](https://github.com/Dlankevi/Tomato-Novel-Downloader) 实例进行搜索与下载。
...
| [Dlankevi/Tomato-Novel-Downloader](https://github.com/Dlankevi/Tomato-Novel-Downloader) | 番茄小说 API 接入与代理策略参考 |
